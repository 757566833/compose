...
reranker_model_name = "jinaai/jina-reranker-m0"

model_local_dir = os.path.join(local_root_dir, reranker_model_name)
...
if __name__ == "__main__":
    ...
    # 执行下载
    reranker_model_path = download_hf_model(reranker_model_name, model_local_dir)
